...
Blockly.Language.controls_arduino_main = {
  helpUrl: 'help',
  init: function() {
    this.setColour(65);
...
Blockly.Language.controls_arduino_motor = {
  helpUrl: 'help',
  init: function() {
    this.setColour(330);
    this.appendDummyInput().appendTitle('Start motors');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Language.controls_arduino_move = {
  helpUrl: 'help',
  init: function() {
    this.setColour(330);
    var dropdown = new Blockly.FieldDropdown(this.OPERATORS);
    this.appendDummyInput().appendTitle(dropdown, 'MOVE');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  }
...
Blockly.Language.controls_arduino_delay = {
  helpUrl: 'help',
  init: function() {
    this.setColour(330);
    this.appendDummyInput().appendTitle('Delay');
...
Blockly.Language.controls_arduino_opponent = {
  helpUrl: 'help',
  init: function() {
    this.setColour(120);
    var dropdown = new Blockly.FieldDropdown(this.OPERATORS);
...
Blockly.Language.controls_arduino_line = {
  ...
  init: function() {
    this.setColour(120);
    var dropdown = new Blockly.FieldDropdown(this.OPERATORS);
    this.appendDummyInput().appendTitle(dropdown, 'LINE');
    this.setOutput(true, Boolean);
    this.setTooltip("");
  }
};

Blockly.Language.controls_arduino_line.OPERATORS =
